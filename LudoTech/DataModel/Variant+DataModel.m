...
+(Variant *) getObjectWithName:(NSString *)name withType: (Difficulty*)difficulty withEntityDescription:(NSEntityDescription *)entity inManagedObjectContext:(NSManagedObjectContext *)context
{
    Variant *retValue = nil;
