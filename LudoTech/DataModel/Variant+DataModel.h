...
+(Variant *) getObjectWithName:(NSString *)name withGame:(Game *)game withDifficulty:(Difficulty *)difficultyGame withEntityDescription:(NSEntityDescription *)entity inManagedObjectContext:(NSManagedObjectContext *)context;
