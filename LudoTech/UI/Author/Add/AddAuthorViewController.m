...
- (IBAction)save:(id)sender
{
    ...
    [Person getObjectWithFirstName:firstname withEdition:self.edition withParam:0 withLastName:lastname withNationality:nationality withEntityDescription:entityDescription inManagedObjectContext:context];
