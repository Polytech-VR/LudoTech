...
#import "EditionTableViewController.h"
#import "EditionTableViewCell.h"
...
@implementation EditionTableViewController
...
{
    static NSString *CellIdentifier = @"EditionTableViewCell";
    // dequeue a editionTableViewCell, then set its edition to the edition for the current row
    EditionTableViewCell *editionCell =
    (EditionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    [self configureCell:editionCell atIndexPath:indexPath];
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject atIndexPath:(NSIndexPath *)indexPath forChangeType:(NSFetchedResultsChangeType)type newIndexPath:(NSIndexPath *)newIndexPath
{
    switch (type)
    {
        ...
        {
            [self configureCell:(EditionTableViewCell *)[self.tableView cellForRowAtIndexPath:indexPath] atIndexPath:indexPath];
            break;
        }
...
- (void)configureCell:(EditionTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    // Fetch Record
    Edition *record = [self.fetchedResultsController objectAtIndexPath:indexPath];
    
    // Update Cell
    [cell.nameEdition setText:record.name];
