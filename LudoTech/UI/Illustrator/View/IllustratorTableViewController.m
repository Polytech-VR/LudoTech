//
//  IllustratorTableViewController.m
//  LudoTech
//
...
@interface IllustratorTableViewController () <NSFetchedResultsControllerDelegate>
...
@implementation IllustratorTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier = @"IllustratorTableViewCell";
    // dequeue a IllustratorTableViewCell, then set its illustrator to the illustrator for the current row
    IllustratorTableViewCell *illustratorCell =
    (IllustratorTableViewCell *)[tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    [self configureCell:illustratorCell atIndexPath:indexPath];
    
    return illustratorCell;
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject atIndexPath:(NSIndexPath *)indexPath forChangeType:(NSFetchedResultsChangeType)type newIndexPath:(NSIndexPath *)newIndexPath {
    switch (type) {
        ...
        case NSFetchedResultsChangeUpdate: {
            [self configureCell:(IllustratorTableViewCell *)[self.tableView cellForRowAtIndexPath:indexPath] atIndexPath:indexPath];
            break;
        }
...
- (void)configureCell:(IllustratorTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    // Fetch Record
